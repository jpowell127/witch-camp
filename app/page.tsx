          ...
          <div className='mx-auto max-w-2xl py-32 sm:py-48 lg:py-56'>
            ...
            <div className='text-center'>
              ...
              <p className='mt-6 text-lg leading-8 text-gray-300'>
                Join us under the moonlit skies for nightly rituals that
                celebrate the cycles of the earth and the magic within us all.
                Connect with a community of like-minded souls as we weave
                spells, share stories, and revel in the mystical energies that
                bind us.
              </p>
